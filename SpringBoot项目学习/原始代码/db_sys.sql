...
insert  into `t_order`(`orderId`,`orderDate`,`userId`,`amount`,`status`) values ('20200803213121','2020-08-03 10:44:10',1,10,1);
...
insert  into `t_user_account`(`userId`,`userName`,`balance`) values (1,'jack',120);
